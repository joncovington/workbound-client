...
export const BuilderInfoForm = ({ open }) => {
  ...
  return (
    <Transition
      visible={open && state.dialogPage === "infoForm"}
              ...
              <Grid columns={2}>
                <Grid.Row>
                  <Grid.Column textAlign="right">
                    <Form.Field>
                      <label>
                        Would you like to add a reference ID to your portfolio?
                      </label>
                    </Form.Field>
                  </Grid.Column>
                  <Grid.Column>
                  ...
                  <Grid.Row>
                    ...
                    <Grid.Column>
                      <Form.Input
                        ...
                        onChange={(e, { value }) =>
                          dispatch(setReference({ referenceId: value }))
                        }
                      />
                    </Grid.Column>
                  </Grid.Row>
          ...
          <Grid columns={2}>
            ...
            <Grid.Column textAlign="right">
              <Button
                ...
                disabled={
                  !showExtraFields ||
                  (showExtraFields === "yes" && state.referenceId === "")
                }
                onClick={() => {
