...
const ProfileDetail = (props) => {
  ...
  const {
    ...
    errors,
    isSubmitting,
  } = useForm(submit, validateProfile);
  ...
  useEffect(() => {
    ...
    if (firstName || lastName) {
      setInputs((inputs) => ({
        ...inputs,
        firstName: { touched: false, value: firstName },
        lastName: { touched: false, value: lastName },
      }));
    } else {
      setInputs((inputs) => ({
        ...inputs,
  ...
  useEffect(() => {
    if (phoneValue !== undefined && phoneValue !== null) {
      if (!isValidPhoneNumber(phoneValue) && phoneValue) {
        ...
        setInputs((inputs) => ({
          ...inputs,
          phone: { touched: true, value: phoneValue },
        }));
      } else {
        setPhoneError(false);
        setInputs((inputs) => ({
      ...
      <Form>
        <Form.Group>
          <Form.Input
            ...
            name="firstName"
            label="First Name"
            value={inputs.firstName ? inputs.firstName.value : ""}
          ...
          <Form.Input
            ...
            name="lastName"
            label="Last Name"
            value={inputs.lastName ? inputs.lastName.value : ""}
            onChange={handleInputChange}
            onBlur={handleBlur}
            error={
